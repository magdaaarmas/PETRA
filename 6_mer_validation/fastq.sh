...
pegRNA_info_file="${experiment_name}/pegRNA_info.csv" # contains variant and pegRNA information necessary for processing
...
for gene in "${genes[@]}"; do
  echo "Processing gene: $gene"
	...
	python raw_counts.py "$gene" "$min_alignment_score" "$genomic_context_file" "$pegRNA_info_file" "$experiment_name"
